...
# for examples
# Extended by Manfred N



export PATH='/bin:/sbin:/usr/bin:/usr/sbin:/usr/local/bin:/usr/local/samba/bin:/usr/local/samba/sbin;/home/$USER/bin;/snap/spotify/current/usr/bin'
...
PS1='\n\[\e[93m\]\D{%d.%m.%Y}\[\e[0m\] \[\e[92m\]\t\[\e[0m\] \[\e[38;5;208;1m\]\H\[\e[0m\] \[\e[38;5;38;1m\]${PS1_CMD1}\[\e[0m\] \[\e[97;101;1;5m\]${PS1_CMD2}\[\e[0m\] \n( \[\e[40;1m\]\w\[\e[0m\] )\n\[\e[1m\]\u\[\e[0m\]\$: ';
